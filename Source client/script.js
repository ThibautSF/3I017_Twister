...
Environnement.prototype = {
	...
	checkSession: function () {
		var request = $.ajax({
			...
			url: "http://localhost:8080/3I017_Twister/user/login",
...
function userDeconnexion(){
	var request = $.ajax({
		method: "POST",
		url: "http://localhost:8080/3I017_Twister/user/logout",
...
function createAccount(form,login,password,nom,prenom,age){
	var request = $.ajax({
		method: "POST",
		url: "http://localhost:8080/3I017_Twister/user/createUser",
...
function getListFriends(init=false) {
	var request = $.ajax({
		method: "POST",
		url: "http://localhost:8080/3I017_Twister/friend/listFriend",
		data: { key: env.sessionKey },
		dataType: "json",
		success: function(msg){
			console.log(msg)
...
function changeFriendStatus(elem) {
	...
	if (env.listFriends[id_friend]!=undefined) {
		...
		var request = $.ajax({
			method: "POST",
			url: "http://localhost:8080/3I017_Twister/friend/removeFriend",
		...
		var request = $.ajax({
			method: "POST",
			url: "http://localhost:8080/3I017_Twister/friend/addFriend",
			data: { key: env.sessionKey, friend: id_friend },
			dataType: "json",
			success: function(msg){
				console.log(msg)
...
function createMessage(form,content,parent) {
	var request = $.ajax({
		method: "POST",
		url: "http://localhost:8080/3I017_Twister/message/addMessage",
...
function getOneMessage(mconteneur,messageId){
	...
	var request = $.ajax({
		method: "GET",
		url: "http://localhost:8080/3I017_Twister/message/getMessage",
...
function getMessages(mconteneur,target="all",nbMax=-1,userId=-1){
	...
	var request = $.ajax({
		method: "GET",
		url: "http://localhost:8080/3I017_Twister/message/listMessage",
...
function requestSearch(form,query){
	var request = $.ajax({
		method: "POST",
		url: "http://localhost:8080/3I017_Twister/services/search",
